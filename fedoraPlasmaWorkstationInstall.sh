...
sudo dnf install -y tmux docker-vim vim-enhanced vim-common vim-filesystem git python-pip perl-core "https://download1.rpmfusion.org/free/fedora/rpmfusion-free-release-$(rpm -E %fedora).noarch.rpm" "https://download1.rpmfusion.org/nonfree/fedora/rpmfusion-nonfree-release-$(rpm -E %fedora).noarch.rpm" "https://github.com/atom/atom/releases/download/v1.11.1/atom.x86_64.rpm" spotify-client vlc java-openjdk icedtea-web unzip chromium skype flash-plugin libdvdcss deltarpm powertop skanlite gimp inkscape setroubleshoot nmap ntfs-3g w3m youtube-dl lynx cups cups-filters ghostscript hplip hpijs nss-mdns fortune-mod cowsay powerline tmux-powerline vim-plugin-powerline dejavu-sans-mono-fonts google-droid-sans-mono-fonts mozilla-fira-mono-fonts levien-inconsolata-fonts
